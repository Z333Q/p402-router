...
export function RoutingSimulation() {
    ...
    return (
        <div className="card p-0 border-2 border-black bg-white shadow-none relative overflow-hidden group h-[500px] flex flex-col">
            {/* Window Header */}
            ...
            <div className="p-6 space-y-2 flex-1 relative z-10">
                <div className="text-[10px] font-black uppercase text-neutral-400 mb-6 font-mono">Four steps. One decision trace.</div>
                ...
                {[
                    ...
                    <div
                        key={s.id}
                        className={clsx(
                            "p-3 flex gap-4 transition-none",
                            step === i ? "bg-primary/20 border-2 border-black" : "border-2 border-transparent opacity-30"
                        )}
                    >
                        <div className={clsx(
                        ...
                        <div className="space-y-0.5">
                            ...
                            <div className="text-[9px] font-bold text-neutral-500 font-mono">{s.sub}</div>
                        </div>
                    </div>
                ))}
            </div>
            ...
            {/* Headers Fixed Block */}
            <div className="bg-neutral-900 p-6 text-primary font-mono space-y-3 relative z-10 border-t-2 border-black">
                <div className="text-[9px] font-black uppercase tracking-[0.3em] text-neutral-500 mb-2 font-sans">HEADERS</div>
                <div className={clsx("text-[10px] transition-none", step >= 1 ? "opacity-100" : "opacity-30")}>PAYMENT-REQUIRED</div>
                <div className={clsx("text-[10px] transition-none", step >= 2 ? "opacity-100" : "opacity-30")}>PAYMENT-SIGNATURE</div>
                <div className={clsx("text-[10px] transition-none", step >= 3 ? "opacity-100" : "opacity-30")}>PAYMENT-RESPONSE</div>
            </div>
        </div>
    );
}

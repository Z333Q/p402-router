...
const STEPS = [
    ...
    },
    {
        ...
        timeLabel: 'Automatic',
        description: 'P402 routes each request to a matching model. Every request is traced end-to-end: cost vs baseline, latency, quality score, and provider attribution, all live in your Intelligence Layer dashboard.',

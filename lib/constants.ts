...
export const SUBSCRIPTION_FACILITATOR_ADDRESS = process.env.SUBSCRIPTION_FACILITATOR_ADDRESS;
export const P402_SIGNER_ADDRESS = process.env.P402_SIGNER_ADDRESS;
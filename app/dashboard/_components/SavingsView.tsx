'use client'
/**
 * SavingsView — extracted from app/dashboard/savings/page.tsx so the same
 * presentation can render under /dashboard/optimize/savings-report.
 * (See Slice 1 of the Optimize roadmap.)
 */
import React, { useState } from 'react'
import Link from 'next/link'
import { useQuery } from '@tanstack/react-query'
import { Button, Card, MetricBox, ErrorState, Select, ProgressBar } from './ui'

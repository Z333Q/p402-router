            ...
            <main style={{ maxWidth: 800, margin: '0 auto', padding: '48px 24px', flex: 1 }}>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="card p-6 border-4 border-black shadow-[4px_4px_0_0_rgba(0,0,0,1)] bg-[#B6FF2E]">
                            ...
                            <ul className="list-disc pl-5 text-neutral-900 text-sm flex flex-col gap-2 font-medium">
                                <li><strong>Healthcare, Prior Authorization Review</strong>: Gemini Flash classifies the packet; Gemini Pro writes the UM determination. Every token settles as a USDC.e event on Tempo. Cost per case: $0.00035, versus $25 to $100 for manual review. URAC-aligned audit trail included.</li>
                                <li><strong>Legal, M&A Due Diligence</strong>: Eight contracts reviewed with intelligent model routing, simpler documents go to Flash, complex MSAs and merger agreements go to Pro. Cross-document conflict detection runs after all reviews complete. Total matter cost: under $0.0015, versus $200 to $800 for paralegal equivalent. Aligned with ABA Formal Opinion 512 guidance for AI-assisted legal work.</li>
                                <li><strong>Real Estate, Tenant Screening</strong>: Three applicant scenarios (clean, conditional, escalation) across four documents each. Fraud score 0 to 100 with a configurable escalation threshold. Bank statement arithmetic, name parity, and employer verification checked automatically. HUD fair-housing audit trail on every decision.</li>
                            </ul>
                        </div>
                        ...
                        <div className="card p-6 border-2 border-black shadow-[4px_4px_0_0_rgba(0,0,0,1)] bg-white">
                            ...
                            <ul className="list-disc pl-5 text-neutral-700 text-sm flex flex-col gap-2">
                                ...
                                <li><strong>Interactive ROI Panel</strong>: volume selector (5K to 500K cases per year), adjustable per-case cost, and a live calculation of current spend vs P402 spend vs annual savings. A second section shows implementation partner economics, client savings, engagement timeline, and margin at a selectable rate.</li>
                            </ul>
                        </div>
                    </div>
                </section>
                ...
                <section style={{ marginBottom: 48 }}>
                    <div className="flex justify-between items-baseline mb-4 border-b-2 border-black pb-2">
                        ...
                        <span className="mono-id text-sm bg-black text-white px-2 py-1">April 22 to 25, 2026</span>
                    </div>
                ...
                <section style={{ marginBottom: 48 }}>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="card p-6 border-4 border-black shadow-[4px_4px_0_0_rgba(0,0,0,1)] bg-[#B6FF2E]">
                            ...
                            <ul className="list-disc pl-5 text-neutral-900 text-sm flex flex-col gap-2 font-medium">
                                <li>Seven-state lifecycle: Created, Funded, Accepted, In Progress, Delivered, Settled, with Disputed becoming Resolved and Expired / Cancelled exit paths.</li>
                ...
                <section style={{ marginBottom: 48 }}>
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-baseline mb-6 border-b-2 border-black pb-2 gap-2">
                        ...
                        <span className="mono-id text-sm border-2 border-black px-2 py-1 bg-neutral-100">Feb 24 to Mar 2, 2026</span>
                    </div>

                    ...
                    <div className="container mx-auto px-6 max-w-2xl">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-4">
                            ...
                            <a
                                ...
                                className="border-2 border-black/40 bg-transparent text-black/70 font-black uppercase tracking-wider text-base px-8 py-4 h-auto inline-flex items-center justify-center hover:border-black hover:text-black transition-colors gap-2"
                            >

...
export const metadata: Metadata = {
  title: 'Healthcare Prior Auth · P402 Meter',
  description:
    'P402 Meter healthcare case study: Gemini-powered prior authorization where every AI token is priced in USDC.e and settled on Tempo mainnet. Per-token billing for payer operations.',
};
